...
export function HelpMessageModal({ isOpen, onClose }: HelpMessageModalProps) {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[99] bg-transparent" aria-hidden onClick={onClose} />
      <div
            ...
            {GUIDE_DATA.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span
                      className={`block w-full pr-2 text-left text-[13px] font-bold leading-snug transition-colors ${
                        isAccordionOpen ? "text-[var(--green-dark)]" : "text-gray-700"
                      }`}
                    >
                    ...
                    <ChevronDown
                      size={16}
                      className={`mt-0.5 shrink-0 text-[var(--green)] transition-transform duration-300 ${
