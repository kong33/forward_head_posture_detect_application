...
export function SegmentToggle<T extends string>({ options, value, onChange, className }: SegmentToggleProps<T>) {
  return (
    <div
      className={cn(
        ...
        return (
          <button
            ...
            className={cn(
              ...
              "[&:not(:last-child)]:mr-1",
              isActive
                ? "bg-[var(--green)] text-white hover:bg-[var(--green)] hover:text-white"
